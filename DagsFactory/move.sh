...
#cp dags/aggregations/dev/requirements.txt ../Docker/airflow/dags/aggregations
...
#cp dags/preprocessing/dev/requirements.txt ../Docker/airflow/dags/preprocessing
